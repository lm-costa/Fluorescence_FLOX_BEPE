...
pear_resul <- vector("list", length = ncol(tab))
for(i in 1:length(pear_resul)){
  pear_resul[[i]] <- cor.test(df$GPP_DT_U95/df$aPAR, tab[,i]/df$aPAR)
}
...
a = dplyr::case_when(
  abs(cos(circular::rad(fobs$SZA))) <=cos(circular::rad(22))~ 81.36 - 13.45*time_table$L750_Wm2nm1sr1,
  abs(cos(circular::rad(fobs$SZA))) <=cos(circular::rad(24)) ~ 78.61 -10.49*time_table$L750_Wm2nm1sr1,
  abs(cos(circular::rad(fobs$SZA))) <=cos(circular::rad(26)) ~ 77.05 -8.78*time_table$L750_Wm2nm1sr1,
  abs(cos(circular::rad(fobs$SZA))) <=cos(circular::rad(28)) ~ 77 -8.727*time_table$L750_Wm2nm1sr1,
  abs(cos(circular::rad(fobs$SZA))) <=cos(circular::rad(30)) ~ 75.157 -6.637*time_table$L750_Wm2nm1sr1,
  abs(cos(circular::rad(fobs$SZA))) <=cos(circular::rad(32)) ~ 73.526 -4.753*time_table$L750_Wm2nm1sr1,
  abs(cos(circular::rad(fobs$SZA))) <=cos(circular::rad(34)) ~ 72.087 -3.057*time_table$L750_Wm2nm1sr1,
  abs(cos(circular::rad(fobs$SZA))) <=cos(circular::rad(36)) ~ 70.665 -1.342*time_table$L750_Wm2nm1sr1,
  abs(cos(circular::rad(fobs$SZA))) <=cos(circular::rad(38)) ~ 68.9615 +0.7643*time_table$L750_Wm2nm1sr1,
  abs(cos(circular::rad(fobs$SZA))) <=cos(circular::rad(40)) ~ 67.24 +2.949*time_table$L750_Wm2nm1sr1,
  abs(cos(circular::rad(fobs$SZA))) <=cos(circular::rad(42)) ~ 65.552 +5.152*time_table$L750_Wm2nm1sr1,
  abs(cos(circular::rad(fobs$SZA))) <=cos(circular::rad(44)) ~ 63.412 +8.033*time_table$L750_Wm2nm1sr1,
  abs(cos(circular::rad(fobs$SZA))) <=cos(circular::rad(46)) ~ 61.39 +10.84*time_table$L750_Wm2nm1sr1,
  abs(cos(circular::rad(fobs$SZA))) > cos(circular::rad(46)) ~ 59.58 +13.45*time_table$L750_Wm2nm1sr1,
)

b = -0.23*(time_table$L750_Wm2nm1sr1)^2 + 0.58*time_table$L750_Wm2nm1sr1 + 0.43
